...
struct matrix {
	...
	unsigned int height;		
	unsigned int kernel_width;	//An increased value of the width of matrix. This must be done, because the the width value must be a multiple of a given value.The value depends on the GPU hardware.
